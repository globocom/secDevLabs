...
Saidajaula Monstro Fit is a Flask API built to demonstrate how a malicious user could exploit a Identity and Authentication vulnerability and escalate his privileges.
