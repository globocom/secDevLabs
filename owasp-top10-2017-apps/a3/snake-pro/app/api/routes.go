...
func Register(c echo.Context) error {
	...
	hash, err := pass.GeneratePasswordHash(userData.Password)
	if err != nil {
		return c.JSON(http.StatusBadRequest, map[string]string{"result": "error", "details": "Error generating password hash."})
	}
