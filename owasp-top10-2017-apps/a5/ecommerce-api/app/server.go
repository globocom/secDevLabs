...
import (
	...
	"github.com/globocom/secDevLabs/owasp-top10-2017-apps/a5/ecommerce-api/app/middlewares"
...
func main() {
	...
	echoInstance.GET("/ticket/:id", handlers.GetTicket, middlewares.JwtAuthentication())
