...
function App() {
    ...
    function Hi() {
        alert("Hello! You have completed level1 !");
    }
    function GetAuthor() {
        alert(
            "{'author':'Meme-Man','password':'Congrats! you have completed level2 :)'}"
        );
    }
    function SetBlog(str) {
        setBlog(str);
        alert("Well done! You have completed level3!!!");
    }
    return (
        <div>
            <Blog blog={blog} />
